    ...
    <html lang="en" className="bg-black text-white">
      <body className={inter.className}>
        <main className="w-full min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
          ...
          <div className="absolute w-[250px] h-[250px] lg:w-[450px] lg:h-[450px] -left-[160px] -top-[100px] lg:-left-[250px] lg:-top-[150px] -z-10 rounded-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-white to-white blur-[90px]" />
          {children}
          <Footer />
        </main>
      </body>
